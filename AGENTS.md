...
## Current scope
- **Current milestone:** Phase 14 warm stylized magical-world art-direction slice is owner-approved and underway. Do not begin Phase 15 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–14. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
