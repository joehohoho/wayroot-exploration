...
## Current scope
- **Current milestone:** Phase 18 major stylized art and animation pass is owner-approved and underway. Do not begin Phase 19 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–18. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
