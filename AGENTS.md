...
## Current scope
- **Current milestone:** Phase 5 homestead and building slice is owner-approved and underway. Do not begin Phase 6 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–5. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
