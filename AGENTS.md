...
## Current scope
- **Current milestone:** Phase 22 alpha visual, camera, and HUD overhaul is owner-approved and underway. Do not begin Phase 23 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–22. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
