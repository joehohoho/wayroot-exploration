...
## Current scope
- **Current milestone:** Phase 20 gentle journey guidance is owner-approved and underway. Do not begin Phase 21 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–20. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
