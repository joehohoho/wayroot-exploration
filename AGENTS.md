...
## Current scope
- **Current milestone:** Phase 12 shelter rest and return utility is owner-approved and underway. Do not begin Phase 13 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–12. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
