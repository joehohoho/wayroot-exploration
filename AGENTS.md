...
## Current scope
- **Current milestone:** Phase 9 production readiness and next-feature planning is owner-approved and underway. Do not begin Phase 10 gameplay expansion without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–9. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
