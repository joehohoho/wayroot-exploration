...
## Current scope
- **Current milestone:** Phase 7 Sunmeadow visual-region slice is owner-approved and underway. Do not begin Phase 8 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–7. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
