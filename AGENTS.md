...
## Current scope
- **Current milestone:** Phase 8 mobile playability and polish slice is owner-approved and underway. Do not begin Phase 9 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–8. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
