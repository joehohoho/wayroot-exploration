...
## Current scope
- **Current milestone:** Phase 6 creature vertical slice is owner-approved and underway. Do not begin Phase 7 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–6. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
