...
## Current scope
- **Current milestone:** Phase 21 dodge and combat-readability pass is owner-approved and underway. Do not begin Phase 22 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–21. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
