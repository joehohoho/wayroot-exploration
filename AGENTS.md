...
## Current scope
- **Current milestone:** Phase 13 restored-grove encounter is owner-approved and underway. Do not begin Phase 14 without approval.
- Unity **6000.5.4f1** is owner-approved and pinned for Phases 0–13. Do not change `ProjectSettings/ProjectVersion.txt` without owner approval.
