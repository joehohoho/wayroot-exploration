...
namespace Wayroot.Editor
{
    public static class PhaseEightBuild
    {
        ...
        {
            string outputPath = Path.Combine("Builds", "Phase8Review", "WayrootPhase8.exe");
            ...
            {
                throw new System.InvalidOperationException($"Phase 8 Windows review build failed: {report.summary.result}");
            }
        }
    }
}
